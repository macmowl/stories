...
const CreatePin: React.FC<Props> = ({ user }) => {
  ...
  const uploadImage = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (
      ...
      client.assets
        ...
        .catch((e) => {
          console.log('Image uplad error: ', e);
        });
    } else {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-5 lg:h-4/5'>
      {fields && (
        <p className='mb-5 text-base text-red-500 transition-all duration-150 ease-in'>
      ...
      <div className='flex flex-col items-center justify-center w-full p-3 bg-white lg:flex-row lg:p-5 lg:w-4/5'>
              ...
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    Use high-quality JPG, SVG, PNG or GIF less than 10MB
                  </p>
                </div>
                <input
                  type='file'
        ...
        <div className='flex flex-col flex-1 w-full gap-6 mt-5 lg:pl-5'>
          <input
            ...
            className='p-2 text-xl border-b-2 border-gray-200 outline-none sm:text-2xl'
          />
          {user && (
